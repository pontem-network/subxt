...
pub mod api {
    ...
    pub mod parachain_system {
        ...
        pub mod calls {
            ...
            #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
            pub struct SetValidationData { pub data : runtime_types :: cumulus_primitives_parachain_inherent :: ParachainInherentData }
    ...
    pub mod parachain_staking {
        ...
        pub mod calls {
            ...
            pub struct SetStakingExpectations {
                pub expectations: runtime_types::parachain_staking::inflation::Range<
                    ::core::primitive::u64,
                >,
            }
                ...
                T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
            {
                ...
                pub fn go_offline(
                    &self,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, GoOffline> {
                    let call = GoOffline {};
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
                pub fn go_online(
                    &self,
                ) -> ::subxt::SubmittableExtrinsic<'a, T, GoOnline> {
                    let call = GoOnline {};
                    ::subxt::SubmittableExtrinsic::new(self.client, call)
                }
        ...
        pub mod storage {
            ...
            impl ::subxt::StorageEntry for Round {
                ...
                type Value = runtime_types::parachain_staking::pallet::RoundInfo<
                    ::core::primitive::u32,
                >;
                fn key(&self) -> ::subxt::StorageEntryKey {
                    ::subxt::StorageEntryKey::Plain
            ...
            impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
                ...
                pub async fn round(
                    ...
                    runtime_types::parachain_staking::pallet::RoundInfo<
                        ::core::primitive::u32,
                    >,
                    ::subxt::Error,
                > {
                ...
                pub async fn nominator_state_iter(
                    ...
                    ::subxt::KeyIter<'a, T, NominatorState>,
                    ::subxt::Error,
                > {
                    self.client.storage().iter(hash).await
                }
                ...
                pub async fn collator_state2_iter(
                    ...
                    ::subxt::KeyIter<'a, T, CollatorState2>,
                    ::subxt::Error,
                > {
                    self.client.storage().iter(hash).await
                }
        ...
        pub mod parachain_staking {
            ...
            pub mod pallet {
                ...
                pub struct Collator2<_0, _1> {
                    ...
                    pub top_nominators: ::std::vec::Vec<
                        runtime_types::parachain_staking::pallet::Bond<_0, _1>,
                    >,
                    pub bottom_nominators: ::std::vec::Vec<
                        runtime_types::parachain_staking::pallet::Bond<_0, _1>,
                    >,
                ...
                pub struct ExitQ<_0> {
                    ...
                    pub nominators_leaving:
                        runtime_types::parachain_staking::set::OrderedSet<_0>,
                    pub candidate_schedule: ::std::vec::Vec<(_0, ::core::primitive::u32)>,
                    pub nominator_schedule: ::std::vec::Vec<(
                        _0,
                        ::core::option::Option<_0>,
                        ::core::primitive::u32,
                    )>,
                }
                #[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
        ...
        T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
    {
        ...
        pub fn parachain_staking(
            &self,
        ) -> parachain_staking::calls::TransactionApi<'a, T> {
